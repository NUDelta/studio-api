...
export const Project = mongoose.model('Project',
  new mongoose.Schema({
      ...
      students: [{ type: mongoose.Schema.Types.ObjectId, ref: 'NonPhdStudent' }], // this only works for undergrads
      sig_head: { type: mongoose.Schema.Types.ObjectId, ref: 'PhdStudent' }, // phd students can have faculty mentor SIG heads
